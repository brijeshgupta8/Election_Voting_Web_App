...
// POST route to invalidate token (logout)
router.post('/logout', jwtAuthMiddleware, async (req, res) => {
    try {
        // In a real scenario, you may want to blacklist or invalidate the token
        // For simplicity, you can send a success message without any action
